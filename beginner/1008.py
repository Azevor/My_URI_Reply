...
in a month and the amount he received per hour. Print the employee's number and
...
m_EmployeeCount = int(input())
m_HourPerMonth = int(input())
m_AmountPerHour = float(input())

print('NUMBER = {}'.format(m_EmployeeCount))
print('SALARY = U$ {:.2f}'.format(m_HourPerMonth*m_AmountPerHour))
